...
public class CommonUtilities {
    ...
    public String readProperty(String property) {
        ...
        try (InputStream input = new FileInputStream(userDir + "//src//config.properties")) {
            prop.load(input);
        ...
        try {
            switch (browserType) {
                case "BS_Chrome":
                    ...
                    caps.setCapability("name", "Keerthi_narahari");
                    driver = new RemoteWebDriver(new URL(URL), caps);
                    driver.get(readProperty("MagicTshirtURL"));
                    break;
                case "BS_Firefox":
                    caps = new DesiredCapabilities();
                    caps.setCapability("os", "Windows");
    ...
    public void magicshirtScenarioOne() {
        ...
        try {
            ...
            String qty = driver.findElement(cart.quantity).getText();
            Assert.assertEquals(qty, "Qty: 1");
    ...
    public void magicshirtScenarioTwo() {
        try {
